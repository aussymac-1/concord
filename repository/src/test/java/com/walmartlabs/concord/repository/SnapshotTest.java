...
public class SnapshotTest {
    ...
    @Test
    public void testSingleFileContainsMatchingPath() {
        Path file = Path.of("/tmp/test.txt");
        Snapshot snapshot = Snapshot.singleFile(file);
        assertTrue(snapshot.contains(file));
    }

    @Test
    public void testSingleFileDoesNotContainOtherPath() {
        Path file = Path.of("/tmp/test.txt");
        Snapshot snapshot = Snapshot.singleFile(file);
        assertFalse(snapshot.contains(Path.of("/tmp/other.txt")));
    }

    @Test
    public void testSingleFileAlwaysModified() {
        Path file = Path.of("/tmp/test.txt");
        Snapshot snapshot = Snapshot.singleFile(file);
    ...
    @Test
    public void testIncludeAllContainsAnyPath() {
    ...
    @Test
    public void testIncludeAllAlwaysModified() {
        Snapshot snapshot = Snapshot.includeAll();
