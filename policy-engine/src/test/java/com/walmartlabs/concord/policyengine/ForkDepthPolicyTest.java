...
public class ForkDepthPolicyTest {
    ...
    @Test
    public void testNullRuleReturnsSuccess() throws Exception {
    ...
    @Test
    public void testDepthBelowMax() throws Exception {
        ForkDepthRule rule = ForkDepthRule.of("too deep", 10);
        ForkDepthPolicy policy = new ForkDepthPolicy(rule);
        CheckResult<ForkDepthRule, Integer> result = policy.check(() -> 5);
        assertTrue(result.getDeny().isEmpty());
    }

    @Test
    public void testDepthAtMax() throws Exception {
    ...
    @Test
    public void testDepthAboveMax() throws Exception {
        ForkDepthRule rule = ForkDepthRule.of("too deep", 3);
        ForkDepthPolicy policy = new ForkDepthPolicy(rule);
