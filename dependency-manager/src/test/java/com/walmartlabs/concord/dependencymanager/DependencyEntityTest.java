...
public class DependencyEntityTest {
    ...
    public void testDirectLinkConstructor() {
        Path path = Paths.get("/tmp/direct.jar");
        URI link = URI.create("https://example.com/lib.jar");
    ...
    public void testEqualsBasedOnPath() {
        Path path = Paths.get("/tmp/artifact.jar");
        DependencyEntity e1 = new DependencyEntity(path, "com.a", "lib1", "1.0");
        DependencyEntity e2 = new DependencyEntity(path, "com.b", "lib2", "2.0");
    ...
    public void testNotEqualsDifferentPath() {
        DependencyEntity e1 = new DependencyEntity(Paths.get("/tmp/a.jar"), "com.a", "lib", "1.0");
        DependencyEntity e2 = new DependencyEntity(Paths.get("/tmp/b.jar"), "com.a", "lib", "1.0");
    ...
    public void testToStringDirectLink() {
        ...
        assertEquals("https://example.com/lib.jar", entity.toString());
    }
    ...
    public void testArtifactToString() {
        DependencyEntity.Artifact artifact = new DependencyEntity.Artifact("com.example", "my-lib", "2.0.0");
