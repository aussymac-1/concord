...
public class ReflectionUtilsTest {
    ...
    public void testFindAnnotationDirectlyOnClass() {
        ...
        assertEquals("on-class", annotation.value());
    }
    ...
    @Test
    public void testFindAnnotationWrongType() {
        OtherAnnotation annotation = ReflectionUtils.findAnnotation(AnnotatedClass.class, OtherAnnotation.class);
        assertNull(annotation);
    }
}
