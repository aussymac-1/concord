...
public class ToStringHelperTest {
    ...
    public void testAddNumber() {
        String result = ToStringHelper.prefix("Test")
                .add("count", (Number) 99)
                .toString();
        assertEquals("Test{count=99}", result);
    }
    ...
    public void testMultipleFields() {
        String result = ToStringHelper.prefix("Person")
                .add("name", "Alice")
                .add("age", (Number) 30)
                .add("active", (Object) true)
                .toString();
        assertEquals("Person{name=\"Alice\", age=30, active=true}", result);
    }

    @Test
    public void testSeparatorOnlyBetweenNonNullValues() {
        String result = ToStringHelper.prefix("Test")
                .add("a", "first")
                .add("b", (String) null)
                .add("c", "third")
                .toString();
        assertEquals("Test{a=\"first\", c=\"third\"}", result);
    }
}
